...
tk.Label(view_frame, text="View Individual Student Record:", bg="#5EC480", font=("Garamond", 10)).pack(side=tk.LEFT, padx=5)
...
text_area = tk.Text(root, height=18, width=70, font=("Garamond", 11), padx=10, pady=10)
