...
class JokeApp:
    def __init__(self, root):
        ...
        self.show_punch_btn = Button(self.frame, text="Show Punchline", command=self.show_punchline)
        self.show_punch_btn.pack(pady=5)
        self.show_punch_btn.config(state=DISABLED)

        self.next_btn = Button(self.frame, text="Next Joke", command=self.show_joke)
    ...
    def show_joke(self):
        ...
        self.show_punch_btn.config(state=NORMAL)
        self.next_btn.config(state=DISABLED)
